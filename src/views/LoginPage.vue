        ...
        <form @submit.prevent="loginUser" class="border border-gray-300 p-4 rounded" >
          ...
          <div class="flex flex-row items-center justify-center lg:justify-start">
            <p class="mb-0 mr-4 text-lg">Connexion avec </p>
              ...
              <!-- Google -->
              <button type="button" data-te-ripple-init data-te-ripple-color="dark" class="mx-1 h-9 w-9 rounded-full bg-primary uppercase leading-normal text-white shadow-[0_4px_9px_-4px_#EA4335] transition duration-150 ease-in-out hover:bg-primary-600 hover:shadow-[0_8px_9px_-4px_rgba(234,67,53,0.3),0_4px_18px_0_rgba(234,67,53,0.2)] focus:bg-primary-600 focus:shadow-[0_8px_9px_-4px_rgba(234,67,53,0.3),0_4px_18px_0_rgba(234,67,53,0.2)] focus:outline-none focus:ring-0 active:bg-primary-700 active:shadow-[0_8px_9px_-4px_rgba(234,67,53,0.3),0_4px_18px_0_rgba(234,67,53,0.2)] dark:shadow-[0_4px_9px_-4px_rgba(234,67,53,0.5)] dark:hover:shadow-[0_8px_9px_-4px_rgba(234,67,53,0.2),0_4px_18px_0_rgba(234,67,53,0.1)] dark:focus:shadow-[0_8px_9px_-4px_rgba(234,67,53,0.2),0_4px_18px_0_rgba(234,67,53,0.1)] dark:active:shadow-[0_8px_9px_-4px_rgba(234,67,53,0.2),0_4px_18px_0_rgba(234,67,53,0.1)]">
                <svg
          ...
          <div class="relative mb-6">
              ...
              <label for="passwordInput" class="absolute left-3 top-2 text-gray-700 transition-all peer-focus:-top-6 peer-focus:text-primary">Password</label>
          </div>
          ...
          <div class="text-center lg:text-left">
            ...
            <!-- Register link -->
            <p class="mb-0 mt-2 pt-1 text-sm font-semibold"> Don't have an account?  
              <a href="/signup" class="text-red-500 hover:text-red-600 focus:outline-none underline focus:text-red-700"> Register </a>
            </p>
